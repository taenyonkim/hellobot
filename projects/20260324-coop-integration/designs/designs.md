...
| ~~S6 로그인 안내 팝업~~ | ~~경고 아이콘, "로그인하기"/"다음에 할래요"~~ | ~~App `23:3813`, Web `23:5028`~~ | **기획 변경: 팝업 폐기 → 로그인 화면 직접 이동** |
| 미로그인 쿠폰 화면 | 상단 로그인 안내 배너 + 쿠폰 화면 | App `9:8750`, Web `9:8755` | 배너: 노란색, X 닫기 |
| 로그인 화면 | 카카오/Apple 로그인 (로그인 후 쿠폰 복귀) | App `207:6717`, Web `207:6706` | **신규 추가** |
