...
| iOS | Phase 1 완료 (QA 이슈 7건 해소, 2건 선결 대기) | feat/coop-integration | worktrees/hellobot_iOS/ | Phase 1 전환 완료 (04-19). ISS-018 해결 (04-19). ISS-019/021/022/023/026/027 해결 (04-21). ISS-030/033/035/038/041 해결 (04-22). ISS-042 해결 (04-22). **ISS-039 해결 (04-23)** — `CouponRegisterErrorMapper` 판정 완화(containsHangul 제거, non-empty 서버값 우선). 잔여: ISS-036(실기기 재현 확인), ISS-040(서버 tags 응답 확인), 카카오 딥링크 진입 처리 |
...
| 웹 | Phase 1 완료 (QA 대응 진행) | feat/coop-integration | worktrees/hellobot-web/ | Phase 1 전환 완료 (04-19~20). ISS-017 해결 (04-19). ISS-016/022/025 해결 (04-21). ISS-031/032/035/036/037/042 해결 (04-22). 잔여: ISS-033(/architect 대기), ISS-034(QA 재검증) |
| 스튜디오 | 해당없음 | - | - | |
