...
- [ ] api-spec.md 작성 (클라이언트용 API 명세)
- [ ] client-guide.md 작성 (클라이언트 개발 가이드)
...
## 의존 관계
- 서버 api-spec.md 작성 완료 → iOS, Android, Web 착수 가능
- 서버 Admin 정산 통계 완료 → 운영 배포 가능
- 쿠프마케팅 상용 인증키 수령 → 프로덕션 배포 가능
- 쿠폰번호 프리픽스 확정 → 코드 판별 로직 최종 확정
