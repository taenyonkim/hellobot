...
- [x] CLAUDE.md에 Git 작업 규칙 추가 (피쳐 브랜치, 충돌 방지, 동시 작업)
- [x] 피쳐 문서 status.md 템플릿에 브랜치 현황 섹션 추가
- [x] 에이전트 커맨드에 작업 시작/종료 절차 반영

## 후속 과업
- [ ] 개별 리포지토리 CLAUDE.md 보완 — Git/배포 규칙 정식 문서화 (repo-git-deploy.md 기반)
- [x] 실제 피쳐로 워크플로우 시범 운영 — coop-integration 프로젝트로 검증 중
- [ ] 시범 운영 후 에이전트 커맨드 개선
