...
| 리포지토리 | 스택 | 역할 |
|-----------|------|------|
| `hellobot-server` | Node.js / Express / TypeORM / PostgreSQL | 메인 API 서버 |
| `hellobot-studio-server` | Java / Spring Boot / MongoDB | 스튜디오(챗봇 빌더) 백엔드 |
| `hellobot-studio-web` | Angular 13 / TypeScript | 스튜디오 프론트엔드 |
| `hellobot-web` | Next.js 14 / React 18 / Tailwind | 메인 웹 (스킬스토어) |
| `hellobot-webview` | Angular 13 SSR / TypeScript | 앱 내 웹뷰 (레거시, 점진적으로 hellobot-web으로 이관 중) |
| `hellobot-report-webview` | Next.js 14 / React 18 / Tailwind | 리포트/분석 웹뷰 |
| `hellobot_android` | Kotlin / MVVM / Hilt / Jetpack Compose | Android 앱 |
| `hellobot_iOS` | Swift / ReactorKit / RxSwift / Tuist | iOS 앱 |
| `common-data-airflow` | Python / Apache Airflow / BigQuery | 데이터 파이프라인 (ETL) |
